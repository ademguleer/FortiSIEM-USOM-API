...
The Extractor (usom_downloader.py): * Role: Runs natively on the Linux OS level (via Cronjob).
...
The Ingestor (usom_threatfeed.py): * Role: Acts as the native FortiSIEM Python Plugin.
